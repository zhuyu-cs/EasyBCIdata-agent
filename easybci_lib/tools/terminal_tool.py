...
def terminal_tool(
    ...
    try:
        ...
        # Skill-compliance guard: refuse commands that try to bypass the
        # pipeline 14-step flow by piping data into the standard
        # mini-repo paths (code/pipeline.py, plan/*.json, preprocessed_output/*,
        # README.md). The guard is a no-op outside *_preprocess_work_dir/ and
        # releases automatically once middle_process/proposal.confirmed exists.
        ...
        try:
            ...
            logger.debug("skill_compliance_guard skipped for terminal", exc_info=True)
