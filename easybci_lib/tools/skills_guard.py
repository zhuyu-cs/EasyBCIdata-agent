...
Trust levels:
  - builtin:   Ships with EasyBCI. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.easybci/\.env|\~/\.easybci/\.env',
     "easybci_env_access", "critical", "exfiltration",
     "directly references EasyBCI secrets file"),
    ...
    (r'\.easybci/config\.yaml|\.easybci/SOUL\.md',
     "easybci_config_mod", "critical", "persistence",
     "references EasyBCI configuration files directly"),
