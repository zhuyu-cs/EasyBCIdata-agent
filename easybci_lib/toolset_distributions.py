...
Usage:
    from easybci_lib.toolset_distributions import get_distribution, list_distributions
...
DISTRIBUTIONS = {
    ...
    # Creative (vision focus)
    "creative": {
        "description": "Vision analysis focus",
        "toolsets": {
            "vision": 90,
            "web": 30
        }
    ...
    # Terminal-focused tasks distribution (for terminal-tasks.jsonl)
    "terminal_tasks": {
