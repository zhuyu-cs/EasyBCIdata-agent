"""
Skills configuration for EasyBCI Agent.
`easybci skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.easybci/config.yaml under:
...
from easybci_cli.config import cfg_get, load_config, save_config
from easybci_cli.colors import Colors, color
from easybci_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `easybci skills`."""
    from easybci_cli.curses_ui import curses_checklist
