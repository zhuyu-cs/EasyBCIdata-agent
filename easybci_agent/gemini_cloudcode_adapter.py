...
This adapter lets EasyBCI use the ``google-gemini-cli`` provider as if it were
...
from easybci_agent import google_oauth
from easybci_agent.gemini_schema import sanitize_gemini_tool_parameters
from easybci_agent.google_code_assist import (
    ...
    def _create_chat_completion(
        ...
        **_: Any,
        ...
        headers = {
            ...
            "User-Agent": "easybci-agent (gemini-cli-compat)",
            "X-Goog-Api-Client": "gl-python/easybci",
...
def _gemini_http_error(response: httpx.Response) -> CodeAssistError:
    ...
    if status == 429 and error_reason == "MODEL_CAPACITY_EXHAUSTED":
        ...
        message = (
            ...
            f"not a EasyBCI issue). Try a different Gemini model or set a "
        ...
        message = (
            ...
            f"retired. Check easybci_cli/models.py for the current list."
        )
    elif err_message:
