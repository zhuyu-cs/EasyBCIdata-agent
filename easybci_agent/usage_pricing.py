...
from easybci_agent.model_metadata import fetch_endpoint_model_metadata, fetch_model_metadata
...
def normalize_usage(
    ...
    *,
    ...
    - Responses API: input_tokens includes cache tokens; input_tokens_details.cached_tokens separates them
    - OpenAI Chat Completions: prompt_tokens includes cache tokens; prompt_tokens_details.cached_tokens separates them

    In both Responses and OpenAI modes, input_tokens is derived by subtracting cache
