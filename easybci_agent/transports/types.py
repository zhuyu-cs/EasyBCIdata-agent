...
class ToolCall:
    ...
    * Responses API: ``{"call_id": "call_XXX", "response_item_id": "fc_XXX"}``
    ...
    * Others: ``None``
    ...
    def call_id(self) -> str | None:
        """Responses API call_id from provider_data, accessed via getattr by _build_assistant_message."""
        return (self.provider_data or {}).get("call_id")

    @property
    def response_item_id(self) -> str | None:
        """Responses API response_item_id from provider_data."""
...
class NormalizedResponse:
    ...
    * Responses API: ``{"responses_reasoning_items": [...], "responses_message_items": [...]}``
    * Others: ``None``
    """
