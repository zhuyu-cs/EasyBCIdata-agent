...
class BedrockTransport(ProviderTransport):
    ...
    def convert_messages(self, messages: List[Dict[str, Any]], **kwargs) -> Any:
        ...
        from easybci_agent.bedrock_adapter import convert_messages_to_converse
        return convert_messages_to_converse(messages)

    def convert_tools(self, tools: List[Dict[str, Any]]) -> Any:
        """Convert OpenAI tool schemas to Bedrock Converse toolConfig."""
        from easybci_agent.bedrock_adapter import convert_tools_to_converse
    ...
    def build_kwargs(
        ...
        **params,
        ...
        """
        from easybci_agent.bedrock_adapter import build_converse_kwargs
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        """
        from easybci_agent.bedrock_adapter import normalize_converse_response
