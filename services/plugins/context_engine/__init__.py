...
Usage:
    from services.plugins.context_engine import discover_context_engines, load_context_engine
...
def _load_engine_from_dir(engine_dir: Path) -> Optional["ContextEngine"]:
    ...
    module_name = f"services.plugins.context_engine.{name}"
    ...
    if module_name in sys.modules:
        ...
        for parent in ("services", "services.plugins", "services.plugins.context_engine"):
